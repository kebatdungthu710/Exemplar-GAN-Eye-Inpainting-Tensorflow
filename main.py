...
flags.DEFINE_boolean("is_load", True, "whether loading the pretraining model for training")
...
if __name__ == "__main__":
    ...
    checkpoint_dir = "/content/drive/My Drive/GoogleColab/Checkpoint/model_gan{}/".format(FLAGS.OPER_NAME)
    sample_path = "/content/drive/My Drive/GoogleColab/Sample/sample{}/sample_{}".format(FLAGS.OPER_FLAG, FLAGS.OPER_NAME)
